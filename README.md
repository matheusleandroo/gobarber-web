...
You need to install NodeJS on your computer before you can use "**GoBarber WEB**". You can install NodeJS by following <a href="https://nodejs.org/en/download/package-manager/">these instructions</a>.
